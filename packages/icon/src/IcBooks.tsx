...
const SvgIcBooks = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    viewBox="0 0 24 24"
    {...props}>
    <path fill="url(#ic_books_svg__a)" d="M0 0h24v24H0z" />
    <defs>
      <pattern id="ic_books_svg__a" width={1} height={1} patternContentUnits="objectBoundingBox">
        <use xlinkHref="#ic_books_svg__b" transform="scale(.01389)" />
      </pattern>
      <image
