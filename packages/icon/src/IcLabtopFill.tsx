...
const SvgIcLabtopFill = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 46 46" {...props}>
    ...
    <path fill="#353F9B" d="M15.1 16.1c0-.6.4-1.1 1-1.1h13.8c.6 0 1.1.5 1 1.1l-.8 6.9H15.9z" />
    <path fill="#D9D9D9" d="M15 23h16l.9 7.9c.1.6-.4 1.1-1 1.1H15.1c-.6 0-1.1-.5-1-1.1z" />
    <path fill="#353F9B" d="M19.5 30h7c.3 0 .5.2.5.5s-.2.5-.5.5h-7c-.3 0-.5-.2-.5-.5s.2-.5.5-.5" />
  </svg>
);
export default SvgIcLabtopFill;
