...
const SvgIcNoticeFill = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={46} height={46} fill="none" {...props}>
    ...
    />
    <path fill="#353F9B" d="m17.5 25.2 3 1 .7 4.9c.1 1.1-.7 2.1-1.9 2.1-1 0-1.9-.8-1.9-1.9v-6.1z" />
  </svg>
);
export default SvgIcNoticeFill;
